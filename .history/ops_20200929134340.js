		...
		xhr.onreadystatechange = function() 
		{
			if (this.readyState == 4 && this.status == 200) 
			{
				...
				for( var i=0; i<jsonObject.searchResults.length; i++ )
				{
					...
					// edit button
					contactList += "<td>" + "<button class='btn btn-primary mr-sm-4' type='button' data-id='" + jsonObject2[4] + " 'data-toggle='modal' data-target='#mymodal2'>Edit</button>";
...
function editContact(){
	...
	var ID = documents.getElementById("contactIdEditContact").value;
