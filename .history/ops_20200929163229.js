		...
		xhr.onreadystatechange = function() 
		{
			if (this.readyState == 4 && this.status == 200) 
			{
				...
				for( var i=0; i<jsonObject.searchResults.length; i++ )
				{
					...
					// edit button
					contactList += "<td>" + "<button class='btn btn-primary mr-sm-4 editContactOpen' type='button' id=" + J data-id='" + jsonObject2[4] + "' data-toggle='modal' data-target='#mymodal2'>Edit</button>";
